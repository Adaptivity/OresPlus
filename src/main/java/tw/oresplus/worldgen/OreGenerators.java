...
public enum OreGenerators  implements IOreGenerator {
	...
	Phosphorite("orePhosphorite", 0, 4, 4, 0, 140),
	...
	public WorldGenOre getGenerator (int dimId) {
		OreGenClass oreGen = ConfigOreGen.getOreGeneratorConfig(this.getDefaultConfig(), dimId);
